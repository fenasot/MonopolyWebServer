...
!function (e, n, t) {
    ...
    function r() {
        ...
        for (var f in x) {
            ...
            for (s = o(n.fn, "function") ? n.fn() : n.fn, r = 0; r < e.length; r++) i = e[r], a = i.split("."), 1 === a.length ? Modernizr[a[0]] = s : (!Modernizr[a[0]] || Modernizr[a[0]] instanceof Boolean || (Modernizr[a[0]] = Boolean(Modernizr[a[0]])), Modernizr[a[0]][a[1]] = s), y.push((s ? "" : "no-") + a.join("-"))
        }
    }
    ...
    function f(e, t, s, o) {
        var r, f, u, l, d = "modernizr", p = i("div"), c = a();
        if (parseInt(s, 10)) for (; s--;) u = i("div"), u.id = o ? o[s] : d + (s + 1), p.appendChild(u);
    ...
    var C = n.documentElement, S = "svg" === C.nodeName.toLowerCase(),
        w = b._config.usePrefixes ? " -webkit- -moz- -o- -ms- ".split(" ") : [];
    b._prefixes = w;
    var _ = "CSS" in e && "supports" in e.CSS, T = "supportsCSS" in e;
    ...
    var k = "Moz O ms Webkit", P = b._config.usePrefixes ? k.split(" ") : [];
    b._cssomPrefixes = P;
